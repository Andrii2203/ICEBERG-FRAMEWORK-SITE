...
export function AuditClient({ featureDict }: AuditClientProps) {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="relative h-[550px] bg-[#0A0A0A]/80 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-cyan-500/5 group">
                ...
                {/* THE CORE SPLIT VIEW */}
                <div className="flex h-full divide-x divide-white/5 relative z-10">

                    {/* LEFT PANEL: Media/Preview (Always Stable 42%) */}
                    <div className="w-[42%] shrink-0 relative overflow-hidden bg-black/40 p-8 flex flex-col">
                        ...
                        <div className="relative w-full h-full rounded-2xl overflow-hidden border border-white/5 bg-white/[0.02] shadow-inner flex items-center justify-center group/preview min-w-0">
                            {!preview ? (
                                <div
                                    key="placeholder"
                        ...
                        {preview && !loading && (
                            <button
                                ...
                                className="mt-6 flex items-center justify-center gap-2 text-[10px] font-black text-white/20 hover:text-white transition-all uppercase tracking-widest"
                            >
                    ...
                    {/* RIGHT PANEL: Actions/Controls (Always Stable 58%) */}
                    <div className="w-[58%] shrink-0 relative flex flex-col p-12">
                        ...
                        {step === "recovering" && (
                            ...
                            >
                                ...
                                <div className="space-y-3">
                                    <h3 className="text-3xl font-black text-white">Resuming Session</h3>
                                    <p className="w-full text-slate-400 text-lg leading-relaxed text-center">
                                        {recoveryMessage}
                                    </p>
                                </div>
                            </div>
                                ...
                                {detection.type === 'ui' ? (
                                    <>
                                        <div className="space-y-4">
                                            ...
                                            <h3 className="text-4xl font-black text-white">Interface Verified</h3>
                                            <p className="text-slate-400 text-lg leading-relaxed">
                                                Our 6-vector analysis engine is ready to generate your full documentation package.
                                            </p>
                                        </div>

                                        <div className="w-full p-10 bg-gradient-to-br from-white/[0.04] to-transparent rounded-[2.5rem] border border-white/5 space-y-8 relative group/card overflow-hidden">
                                            <div className="relative z-10 flex justify-between items-center">
                                                <div className="space-y-1">
                                                    <h4 className="text-2xl font-black text-white">Iceberg Pro Audit</h4>
                                                    <p className="text-xs font-bold text-white/40 tracking-widest uppercase">One-time payment</p>
                                                </div>
                                                <div className="text-4xl font-black text-white tracking-tighter">29€</div>
                                            </div>

                                            <ul className="relative z-10 grid grid-cols-2 gap-4">
                                                {["ZIP-Package", "Code Mapping", "UX Analysis", "Claude 4.5"].map((item, idx) => (
                                                    <li key={idx} className="flex items-center gap-3 text-xs font-bold text-white/50">
                                            ...
                                            <button
                                                ...
                                                disabled={loading}
                                                className="relative z-10 w-full py-5 bg-cyan-500 hover:bg-cyan-400 text-black font-black rounded-2xl shadow-2xl shadow-cyan-500/20 transition-all flex items-center justify-center gap-3 text-lg group-hover/card:scale-[1.02]"
                                            >
